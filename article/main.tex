...
\begin{figure}[!tbp]
  \centering
  \subfloat[Run time with $n_{bin}$(bin number) as a variable.]{\includegraphics[width=0.5\textwidth]{figures/normal_S.png}\label{fig:noarmalS}}
  \hfill
  \subfloat[Run time with $n$(sample size) as a variable.]{\includegraphics[width=0.5\textwidth]{figures/normal_N.png}\label{fig:normalN}}
...
\begin{figure}[H]
  \centering
  \subfloat[Boxplot of the relative error with bin size as varaible.]{\includegraphics[width=0.5\textwidth]{figures/box_plot_Diff_rel_2.jpg}\label{fig:noarmalS}}
  \hfill
  \subfloat[Errorplot of the relative error with bin size as varaible.]{\includegraphics[width=0.5\textwidth]{figures/error_plot_Diff_rel_2.jpg}\label{fig:normalN}}
  \caption{Relative error vs Bin size}
\end{figure}
\begin{figure}[H]
  \centering
  \subfloat[Boxplot of the relative error with bin size as varaible.]{\includegraphics[width=0.5\textwidth]{figures/box_plot_Diff_rel_6.jpg}\label{fig:noarmalS}}
  \hfill
  \subfloat[Errorplot of the relative error with bin size as varaible.]{\includegraphics[width=0.5\textwidth]{figures/error_plot_Diff_rel_6.jpg}\label{fig:normalN}}
  \caption{Relative error vs Bin size}
\end{figure}
